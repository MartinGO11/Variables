...
function render(variables = {}) {
  ...
  if (variables.twitter === null) variables.twitter = "MvrtinG11";
  if (variables.github === null) variables.github = "MartinGO11";
  if (variables.linkedin === null)
    variables.linkedin = "martin-gutierrez-4287a818b";
  if (variables.instagram === null) variables.instagram = "mvrt1n.g";
